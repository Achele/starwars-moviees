...
function App() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setLoading(false);
        // data.forEach((result) => {
        //   const movieDetails = result.opening_crawl.split("");
        //   const movieDetailsSummary = movieDetails.slice(0, 33).join("");
        //   result.movieDetailsSummary =
        //     movieDetailsSummary + (movieDetails.length > 33 ? "..." : "");
        // });
  ...
  const movies = data?.map((result, index) => {
    console.log(result.movieDetailsSummary);
